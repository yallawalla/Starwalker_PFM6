...
//bool ISO15693_INITIALISATION					(uc8 *pCommand, uint8_t *pResponse);
//bool ISO15693_INITIALISATION1					(uc8 *pCommand, uint8_t *pResponse);
...
int8_t ISO15693_ReadMultipleBlocks 				(uc8 Flags, uc8 *UIDin, uc8 BlockNumber, uc8 NbBlocks,uint8_t *pResponse);
...
//int8_t ISO15693_GetDSFID 						(uint8_t *DSFIDout); 
//int8_t ISO15693_GetAFI 							(uint8_t *AFIout);
//int8_t ISO15693_GetMemSizeInfo 					(uint8_t *NbBlock,uint8_t *MemSize); 
int8_t ISO15693_GetIcRef 							(uint8_t *IcRefOut);
int8_t ISO15693_IsPresent 						(void);

int8_t ISO15693_GetRFUFlag 					(uc8 FlagsByte);
...
int8_t ISO15693_GetInventoryFlag 			(uc8 FlagsByte);
...
int8_t ISO15693_IsCollisionDetected 		(uc8 *pTagReply);
int8_t ISO15693_IsATagInTheField 			(uc8 *pTagReply);
uint8_t ISO15693_IsTagErrorCode 			(uc8 Flag);
int8_t ISO15693_IsThisTagPresent 			(uc8 *UIDin);


int8_t ISO15693_SplitInventoryResponse			(uc8 *TagResponse,uc8 Length,uint8_t *Flags , uint8_t *DSFIDextract, uint8_t *UIDout);
int8_t ISO15693_SplitGetSystemInfoResponse		(uc8 *TagResponse,uc8 Length,uint8_t *Flags ,uint8_t *InfoFlags,uint8_t *UIDout,uint8_t *DSFIDout,uint8_t *AFIout,uint8_t *MemSizeOut,uint8_t *IcRefOut,uint8_t *ErrorCode);
int8_t ISO15693_SplitMemorySizeInfo				(uc16 MemSizeInfo,uint8_t *BlockSize ,uint8_t *NbBlocks);
int8_t ISO15693_SplitReadSingleBlockResponse	(uc8 *TagResponse,uc8 Length,uc8 NbByteOfData,uc8 OptionFlag,uint8_t *Flags ,uint8_t *SecurityStatus,uint8_t *Data,uint8_t *ErrorCode);
int8_t ISO15693_SplitWriteSingleBlockResponse	(uc8 *TagResponse,uc8 Length,uint8_t *Flags ,uint8_t *ErrorCode);
int8_t ISO15693_SplitWriteMultipleBlockResponse	(uc8 *TagResponse,uc8 Length,uint8_t *Flags ,uint8_t *ErrorCode);
int8_t ISO15693_SplitWriteAFIResponse			(uc8 *TagResponse,uc8 Length,uint8_t *Flags ,uint8_t *ErrorCode);
int8_t ISO15693_SplitWriteDSFIDResponse			(uc8 *TagResponse,uc8 Length,uint8_t *Flags ,uint8_t *ErrorCode);
int8_t ISO15693_SplitLockBlockResponse			(uc8 *TagResponse,uc8 Length,uint8_t *Flags ,uint8_t *ErrorCode);
int8_t ISO15693_SplitLockAFIResponse			(uc8 *TagResponse,uc8 Length,uint8_t *Flags ,uint8_t *ErrorCode);
int8_t ISO15693_SplitLockDSFIDResponse			(uc8 *TagResponse,uc8 Length,uint8_t *Flags ,uint8_t *ErrorCode);
int8_t ISO15693_SplitReadMultipleBlockResponse	(uc8 *TagResponse,uc8 Length,uc8 NbBlock,uc8 NbByteOfData,uc8 OptionFlag,uint8_t *Flags ,uint8_t *SecurityStatus,uint8_t *Data,uint8_t *ErrorCode);
int8_t ISO15693_SplitSelectResponse				(uc8 *TagResponse,uc8 Length,uint8_t *Flags ,uint8_t *ErrorCode);
int8_t ISO15693_SplitResetToReadyResponse		(uc8 *TagResponse,uc8 Length,uint8_t *Flags ,uint8_t *ErrorCode);
int8_t ISO15693_SplitGetMultipleBlockSecutityResponse( uc8 *TagResponse,uc8 Length,uc8 NbBlock,uint8_t *Flags ,uint8_t *DataOut,uint8_t *ErrorCode);
int8_t ISO15693_SplitBasicResponse				(uc8 *TagResponse,uc8 Length,uint8_t *Flags ,uint8_t *ErrorCode);


// testing function
int8_t ISO15693_InventoryScanChain (uint8_t *UIDin,uint8_t AFIin, uint8_t *ScanChainResult);
int8_t ISO15693_ReadWriteSingleBlockScanChain (uint8_t *UIDin,uint8_t AFIin, uint8_t *ScanChainResult);


int8_t ISO15693_IsReaderConfigMatchWithFlag( uc8 GloParameterSelected , uc8 Flags);
int8_t ISO15693_IsReaderConfigMatchWithFlagWriteCmd( uc8 GloParameterSelected , uc8 Flags);
...
int16_t ISO15693_CRC16 (uc8 *DataIn,uc8 Length);
